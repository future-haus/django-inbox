    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', JSONField(blank=True, db_index=True, help_text='Arbitrary data that can be used by consuming  clients/signal listeners as needed (eg needing extra data to pass with Gmail emails for actions, extra data for push notifications for interactive notifications.', null=True)),
